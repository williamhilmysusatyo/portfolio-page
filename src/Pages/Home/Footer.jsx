  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://web.facebook.com/william.hilmy/"
            ...
            <li>
              <a
                href="https://www.instagram.com/williamhilmysusatyo/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/william-hilmy-susatyo-440732170/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content"><b>Made originally by William</b></p>
      </div>
    </footer>
  );
}
